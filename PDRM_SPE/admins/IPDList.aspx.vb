...
#Region "Languange"
    Private Sub SetText()
        ...
        'Header/Title
        lblPageTitle.Text = GetText("IPDList")
        lblHeader.Text = GetText("IPDList")
...
#Region "Table binding"
    ...
    Private Sub BindTable()
        Dim myDataTable As DataTable = PoliceStationManager.GetPoliceStationList(-1, ddlSIPK.SelectedValue, -1, "IPD", "", "", "", "Y")
