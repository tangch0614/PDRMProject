...
#Region "Languange"
    Private Sub SetText()
        ...
        'Header/Title
        lblPageTitle.Text = GetText("AdminList")
        lblHeader.Text = GetText("AdminList")
        lblInfo.Text = GetText("AdminInfo")
        lblLPasswordHeader.Text = GetText("ChangePassword")
        'Search
        lblSUserID.Text = GetText("Username")
        lblSName.Text = GetText("Name")
        lblSIC.Text = GetText("ICNum")
        lblSPoliceNo.Text = GetText("PoliceIDNo")
        lblSLevel.Text = GetText("RoleLevel")
...
#Region "Initialize"
    ...
    Private Sub GetLevel()
        ...
        ddlSLevel.DataSource = RoleManager.GetRoleList("A")
        ddlSLevel.DataTextField = "fldRoleName"
        ddlSLevel.DataValueField = "fldRoleID"
        ddlSLevel.DataBind()
        ddlSLevel.Items.Insert(0, New ListItem(GetText("All"), -1))
...
#Region "Table binding"
    ...
    Private Sub BindTable()
        Dim myDataTable As DataTable = AdminManager.SearchAdminList(0, ddlSLevel.SelectedValue, 0, txtSUserID.Text, txtSName.Text, txtSIC.Text, txtSPoliceNo.Text, ddlSDepartment.SelectedValue, ddlSPoliceStation.SelectedValue, "", ddlSStatus.SelectedValue, "", "")
