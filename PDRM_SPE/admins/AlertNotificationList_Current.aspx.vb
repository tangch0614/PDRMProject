...
Public Class AAlertNotificationList_Current
    Inherits ABase
...
#Region "Languange"
    Private Sub SetText()
        'Header/Title
        lblPageTitle.Text = GetText("CurrentAlertList")
    End Sub
...
#Region "Table binding"
    ...
    Public Shared Function GetAlertList(severity As String, limit As Integer) As String
        Dim myDataTable As DataTable = AlertManager.GetAlertList(-1, -1, -1, 1, "", severity, "", "", -1, limit, " fldID Desc ")
    ...
    Public Shared Function GetAlertCount(severity As String) As Integer
        Return AlertManager.CountAlert(-1, -1, -1, 1, severity, -1)
    End Function
