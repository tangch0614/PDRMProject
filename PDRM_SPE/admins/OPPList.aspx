                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:Button runat="server" CssClass="btn blue" ID="btnSearch" Text="Cari" OnClick="btnSearch_Click" />
                                        <asp:Button runat="server" CssClass="btn " ID="btnSReset" Text="Set Semula" OnClick="btnSReset_Click" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <asp:Label runat="server" ID="txtStatus" Text='<%#If(Eval("fldStatus").Equals("Y"), GetText("Active"), If(Eval("fldStatus").Equals("Y"), GetText("Inactive"), GetText("Pending")))%>' CssClass='<%#If(Eval("fldStatus").Equals("Y"), "label label-success", If(Eval("fldStatus").Equals("Y"), "label label-danger", "label label-warning"))%>'></asp:Label>
                                            </td>
                                            <td style="text-align: center">
                                            ...
                                            <td style="text-align: center">
                                                <asp:Button runat="server" ID="btnVerify" Text='<%#If(Eval("fldStatus").Equals("P"), GetText("Verify"), GetText("View"))%>' CommandName="verify" CommandArgument='<%#Eval("fldID")%>' Visible='<%#GetUserType() = 3%>' CssClass="btn blue btn-xs margin-bottom-5" />
                                ...
                                <div class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox runat="server" ID="txtPhoto1" CssClass="form-control input-inline input-large" onkeydown="return false;" onpaste="return false;" autocomplete="off" ClientIDMode="static"></asp:TextBox>
                                                ...
                                                <asp:Image runat="server" ID="imgPhoto1Preview" ClientIDMode="Static" Style="height: 250px; display: block;" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <asp:TextBox runat="server" ID="txtPhoto2" CssClass="form-control input-inline input-large" onkeydown="return false;" onpaste="return false;" autocomplete="off" ClientIDMode="static"></asp:TextBox>
                                                <label style="color: red">*</label>
                                                ...
                                                <asp:Image runat="server" ID="imgPhoto2Preview" ClientIDMode="Static" Style="height: 250px; display: block;" />
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-actions">
                                <div class="pull-right">
                                    ...
                                    <asp:Button runat="server" CssClass="btn default " ID="btnBack2" Text="Kembali" OnClick="btnBack_Click" ClientIDMode="static" />
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <label style="color: red">*</label>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvGeofenceMukim" ControlToValidate="ddlGeofenceMukim" InitialValue="" ErrorMessage="*cannot be blank" Display="Dynamic" ForeColor="red" ValidationGroup="geofence"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <asp:Label runat="server" ID="lblGeofenceStatus" CssClass="col-md-4 control-label" Text="Mukim"></asp:Label>
                                            <div class="col-md-8">
                                                <asp:Label runat="server" ID="txtGeofenceStatus" CssClass="form-control-static"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions">
                                        <div class="pull-right">
                                            <asp:Button runat="server" CssClass="btn blue " ID="btnSubmitGeofence" Text="Update" UseSubmitBehavior="false" OnClientClick='if(!validate2(this,"hfConfirm","geofence")){return false};' OnClick="btnSubmitGeofence_Click" ClientIDMode="static" />
                                            <asp:Button runat="server" CssClass="btn blue " ID="btnResetGeofence" Text="Update" OnClick="btnResetGeofence_Click" ClientIDMode="static" />
                                            ...
                                            <asp:Button runat="server" CssClass="btn default " ID="btnBack3" Text="Kembali" OnClick="btnBack_Click" ClientIDMode="static" />
                                        </div>
                                    </div>
                                </ContentTemplate>
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="btnResetGeofence" />
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-actions">
                                <div class="pull-right">
                                    ...
                                    <asp:Button runat="server" CssClass="btn default " ID="btnBack4" Text="Kembali" OnClick="btnBack_Click" ClientIDMode="static" />
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <asp:Image runat="server" ID="imgPPhoto1Preview" ClientIDMode="Static" Style="height: 250px; display: block;" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <asp:Label runat="server" ID="lblPPhoto2" CssClass="col-md-4 control-label" Text="Gambar Subjek (Badan)"></asp:Label>
                                                <div class="col-md-8">
                                                    <asp:Image runat="server" ID="imgPPhoto2Preview" ClientIDMode="Static" Style="height: 250px; display: block;" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-lg-offset-4">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 0 10px;">
                                                                <asp:Label runat="server" ID="lblPBeaconCode" Style="margin-right: 5px;" Text="IMEI" Enabled="false"></asp:Label><asp:Label runat="server" ID="txtPBeaconCode" CssClass="form-control input-inline input-small"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 0 10px;">
