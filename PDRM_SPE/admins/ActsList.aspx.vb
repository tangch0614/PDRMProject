...
#Region "Languange"
    Private Sub SetText()
        ...
        'Header/Title
        lblPageTitle.Text = GetText("Acts")
        lblHeader.Text = GetText("Acts")
        lblInfo.Text = GetText("Maklumat Akta")
        'Search
        lblSStatus.Text = GetText("Status")
        btnSearch.Text = GetText("Search")
        btnSReset.Text = GetText("Reset")
        'details
        lblName.Text = GetText("Acts")
        rfvName.ErrorMessage = GetText("ErrorItemRequired").Replace("vITEM", GetText("Acts"))
