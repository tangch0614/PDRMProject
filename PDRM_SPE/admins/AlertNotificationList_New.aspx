<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admins/Admin.Master" CodeBehind="AlertNotificationList_New.aspx.vb" Inherits="PDRM_SPE.AAlertNotificationList_New" %>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        ...
                        data: JSON.stringify({ processstatus: 0, severity: severity }),
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (response) {
