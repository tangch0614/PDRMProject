<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admins/Admin.Master" CodeBehind="PoliceStationList.aspx.vb" Inherits="PDRM_SPE.APoliceStationList" %>
                                        ...
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <%--<div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <asp:DropDownList runat="server" ID="ddlSState" ClientIDMode="Static" CssClass="form-control input-inline input-large" AutoPostBack="true" OnSelectedIndexChanged="ddlSState_SelectedIndexChanged"></asp:DropDownList>
                                                    </div>
                                                </div>--%>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <asp:Label runat="server" ID="lblSIPD" CssClass="col-md-3 control-label" Text="Status"></asp:Label>
                                                    <div class="col-md-8">
                                                        <asp:DropDownList runat="server" ID="ddlSIPD" ClientIDMode="Static" CssClass="form-control input-inline input-large"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </ContentTemplate>
                                            <Triggers>
                            ...
                            <div class="portlet-body form">
                                <div class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <asp:Label runat="server" ID="lblIPD" CssClass="col-md-3 control-label" Text="Status"></asp:Label>
                                            <div class="col-md-8">
                                                <asp:DropDownList runat="server" ID="ddlIPD" ClientIDMode="Static" CssClass="form-control input-inline input-large"></asp:DropDownList>
                                                <asp:RequiredFieldValidator runat="server" ID="rfvIPD" ControlToValidate="ddlIPD" InitialValue="" ErrorMessage="*Name cannot be blank" Display="Dynamic" ForeColor="red" ValidationGroup="update"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="form-group">
