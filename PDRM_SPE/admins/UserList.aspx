<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admins/Admin.Master" CodeBehind="UserList.aspx.vb" Inherits="PDRM_SPE.AUserList" %>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <asp:Label runat="server" ID="lblSIC" CssClass="col-md-3 control-label" Text="I/C Number"></asp:Label>
                                                    <div class="col-md-8">
                                                        <asp:TextBox runat="server" ID="txtSIC" CssClass="form-control input-inline input-large"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <asp:Label runat="server" ID="lblSLevel" CssClass="col-md-3 control-label" Text="Role"></asp:Label>
                                                    <div class="col-md-8">
                                                        <asp:DropDownList ID="ddlSLevel" runat="server" CssClass="form-control input-inline input-large"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <table class="table table-striped table-hover table-bordered managedTable" id="table1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 10% !important">
                                                                <asp:Label runat="server" ID="lblHICNo" Text='<%#GetText("ICNum")%>'></asp:Label>
                                                            </th>
                                                            <th style="width: 10% !important">
                                                            ...
                                                            <th style="width: 5% !important">
                                                                <asp:Label runat="server" ID="lblHLevel" Text='<%#GetText("RoleLevel")%>'></asp:Label>
                                                            </th>
                                                            <th style="width: 5% !important">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <asp:Label runat="server" ID="txtICNo" Text='<%#Eval("fldICNo")%>'></asp:Label>
                                                    </td>
                                                    <td style="text-align: center">
                                                    ...
                                                    <td style="text-align: center">
                                                        <asp:Label runat="server" ID="txtLevel" Text='<%#GetText(Eval("fldRoleName"))%>'></asp:Label>
                                                    </td>
                                                    <td style="text-align: center">
                            ...
                            <div class="form-horizontal">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <asp:DropDownList ID="ddlLevel" runat="server" CssClass="form-control input-inline input-large"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="form-group">
